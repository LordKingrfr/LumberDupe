...
ImageButton.Image = "https://st4.depositphotos.com/24580870/40421/i/600/depositphotos_404212244-stock-photo-3d-illustration-red-number-600.jpg"
...
TextLabel.Text = "Olá Mestre (:"
else
TextLabel.Text = "Bem-vindo "..game.Players.LocalPlayer.Name
end
...
game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "By VictorRoxxy",
                Text = "Voce nao pode ter nenhum slot carregado",
                Duration = 15,
                })
return
end
...
game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "By VictorRoxxy",
                Text = "Voce deve esperar ate que o dupe acabe",
                Duration = 15,
                })
return
end
...
game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "By VictorRoxY",
                Text = "Você Deve carregar sua base, repita o comando novamente",
                Duration = 15,
                })
Duping = false
return 
...
game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "By VictorRoxxy",
                Text = "Carregue seu Save e espere o dinheiro voltar!",
                Duration = 15,
                })
end
end
